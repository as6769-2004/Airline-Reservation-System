        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">Flight Booking Made Easy</p>
              </div>
            </div>
            <p className="text-gray-400 mb-4 max-w-md">
              Your trusted partner for seamless flight booking experiences across India. 
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li><a href="#" className="hover:text-white transition-colors">Booking Help</a></li>
